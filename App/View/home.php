    ...
    <main>
        ...
        <nav class="navbar navbar-expand-lg navbar-primary bg-light shadow-lg">
            <div class="container-fluid ">
                <a class="navbar-brand p-3" href="#"><img src="https://github.com/patrikrufino/livre/blob/main/Resources/Img/livre_logo.png?raw=true" alt="Logo Livre" style="max-width: 50px;"></a>
