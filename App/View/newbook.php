...
<body class="bg-light">
    ...
    <nav class="navbar navbar-expand-lg navbar-prymary bg-light shadow-lg">
        <div class="container-fluid ">
            <a class="navbar-brand p-3" href="home.php"><img src="https://github.com/patrikrufino/livre/blob/main/Public/Img/livre_logo.png?raw=true" alt="livre_logo" style="max-width: 50px;"></a>
